...
const Home = () => {
  return (
    ...
    >
      <div className="bg-[url('./images/download.png')] fixed h-full w-full top-0 opacity-50"></div>
      <div className="relative z-10 text-center flex flex-col gap-5 md:gap-3  text-[#ffffff] -mt-36 md:-mt-100 lg:mt-0">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl  text-center font-[700px] text-[#47A025] pt-5">
          I build beautiful, responsive websites.
        </h1>



        <p className="text-[12px] sm:text-lg md:text-[18px] pt-5 px-10 font-[400px] text-[#ffffff]">
          A passionate frontend developer with a deep love for building
          user-friendly, responsive web experiences.
        </p>
      </div>
      <div className="flex gap-15 mt-12 animate__animated animate__pulse">
        <a
          href="#projects"
      ...
      <div className="flex md:space-x-4 mt-15 text-[20px] md:text-[24px] z-10 gap-15 animate__animated animate__fadeInTopLeft">
        <a
      ...
      {/* vertical icons */}
      <div className="fixed left-10 z-5 lg:top-130 xs">
